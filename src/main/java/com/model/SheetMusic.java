...
public class SheetMusic {
    ...
    public boolean saveToFile(List<Song> song) {
        if (song != null) {
            try (FileWriter writer = new FileWriter(((SheetMusic) song).getTitle() + ".txt")) {
                ...
                System.out.println("Sheet music saved to " + ((SheetMusic) song).getTitle() + ".txt");
                return true;
